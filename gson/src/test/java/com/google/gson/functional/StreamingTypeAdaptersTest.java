...
public final class StreamingTypeAdaptersTest extends TestCase {
  ...
  public void testSerialize() {
    ...
    assertEquals("{'horsePower':300.0,"
        ...
        truckAdapter.toJson(truck, WriteContext.create(miniGson, truck)).replace('\"', '\''));
  }
  ...
  public void testSerializeMap() {
    ...
    map.put("a", 5.0);
    map.put("b", 10.0);
    assertEquals("{'a':5.0,'b':10.0}",
            mapAdapter.toJson(map, WriteContext.create(miniGson, map)).replace('"', '\''));
  }
  ...
  public void testSerialize1dArray() {
    ...
    assertEquals("[1.0,2.0,3.0]",
            arrayAdapter.toJson(new double[]{ 1.0, 2.0, 3.0 }, WriteContext.create(miniGson, null)));
  }
  ...
  public void testSerialize2dArray() {
    ...
    assertEquals("[[1.0,2.0],[3.0]]", arrayAdapter.toJson(array, WriteContext.create(miniGson, null)));
  }
  ...
  public void testSerializeRecursive() {
    ...
    assertEquals("{'label':'root',"
        ...
        nodeAdapter.toJson(root, WriteContext.create(miniGson, root)).replace('"', '\''));
  }
  ...
  public void testFromJsonTree() {
    ...
    Truck truck = truckAdapter.fromJsonTree(truckObject, ReadContext.nullContext());
    assertEquals(300.0, truck.horsePower);
