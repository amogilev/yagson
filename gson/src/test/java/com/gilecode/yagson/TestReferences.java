...
import static com.gilecode.yagson.TestingUtils.gsonAllDuplicatesMode;
import static com.gilecode.yagson.TestingUtils.gsonCircularOnlyMode;
...
public class TestReferences extends TestCase {
	...
	public void testObjectRefs() {
		...
		Node n = new Node(1);
		arr[0] = arr[1] = n;
		TestingUtils.testFully(arr, jsonStr("[{'@type':'com.gilecode.yagson.Node','@val':{'id':1,'connections':[]}},'@.0']"));
	}
}
